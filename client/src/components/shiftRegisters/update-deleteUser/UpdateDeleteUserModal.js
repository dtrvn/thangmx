...
import { updateOrDeleteUser } from "../../../actions/shiftRegister";
...
const UpdateDeleteUserModal = ({
    ...
    const onSubmit = (e) => {
        ...
        if (value === false) {
            ...
            if (formData.userId === currentUserLineId) {
                // No change
                formData.userFlag = "0";
            } else {
                // Change user (Update)
    ...
    return (
        <Fragment>
            <div id="responsive-modal-UpdateDeleteUser" className="modal" tabIndex={-1} style={{ display: 'none' }} data-backdrop="static"
                data-keyboard="true">
...
export default connect(null, { updateOrDeleteUser })(
